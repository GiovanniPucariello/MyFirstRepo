...
<body>
	...
	<ul class="sf-menu">
		<li class="current"><a href="#a">订单管理</a>
			<ul>
				<li><a href="#aa">订单创建</a></li>
				<li><a href="#aa">订单查询</a></li>
				<li><a href="#aa">订单修改</a></li>
				<li><a href="#aa">订单删除</a></li>
			</ul>
		</li>
		<li class="current"><a href="#a">我的购物车</a>
		</li>
	</ul>
	<ul>
